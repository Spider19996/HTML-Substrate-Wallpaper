const CONFIG = {
    ...
    // ANIMATION TIMING
    RESET_AFTER_SECONDS:     60,       // Seconds before automatic reset (0 = only reset when no cracks left)
    ...
    FPS_COUNTER_COLOR:       [0, 0, 0], // RGB color of FPS counter text [R, G, B] (0-255 each)
