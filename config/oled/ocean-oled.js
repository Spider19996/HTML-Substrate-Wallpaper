const CONFIG = {
    ...
    FPS_COUNTER_COLOR:       [100, 100, 100], // RGB color of FPS counter text [R, G, B] (0-255 each)
    TARGET_FPS:              60,       // Maximum framerate limit (0 = unlimited, lower = less CPU/GPU usage)
    
    // COLORS - Ocean OLED theme: Bright aquatic colors on black
    BG_COLOR:                [0, 0, 0], // Pure black background (OLED optimized)
    COLORS: [
        [0, 150, 200],    // Ocean blue
        [0, 180, 230],    // Bright azure
        [64, 224, 208],   // Turquoise
        [0, 255, 255],    // Cyan
        [100, 210, 255],  // Sky blue
